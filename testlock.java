...
public class lock {
    public static void main(String[] args) throws Exception {
        if (args.length != 4) {
            ...
            //Decodes Public Key
            String pubAlgoz = publicKeyScanner2.nextLine(); // not used
            String PublicKeyz = publicKeyScanner2.nextLine(); // this will stop when it hits a newline and the encoded key may have the newline char value causing the private key to be piecemeal
